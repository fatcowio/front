...
const _mock = {
  ...
  text: {
    ...
    groupName: (index: number) => groupName[index],
    eventTitle: (index: number) => eventTitle[index],
    eventDescription: (index: number) => eventDescription[index],
    eventCover: (index: number) => eventCover[index],
    eventContent: (index: number) => eventContent[index],
    groupCover: (index: number) => groupCover[index],
  },
  number: {
